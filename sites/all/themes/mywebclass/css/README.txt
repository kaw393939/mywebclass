...
To use these stylesheets, rename the files and mywebclass with the name of your theme.
...
mywebclass-alpha-default-narrow.css  
...
mywebclass-alpha-default-normal.css
...
mywebclass-alpha-default-wide.css
